...
public final class GridProjectShaders implements ClientModInitializer {
    public static ShaderProgram PROGRAM;
    public static final Identifier ID = Identifier.of("karma-gate-mod", "karma_grid_project");
